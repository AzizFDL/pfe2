		  ...
		  @FXML
		   ...
		   @FXML
		    void recupererInfoTube() {
		        ...
		        diam = TFDiametre.getText();
		        temperatureClass = TFTemp.getText();
		        len = TFLength.getText(); 
	 		    tube = myChoiceBox.getValue();
		        ...
		        System.out.println(singlePart + " " + refInterne + " " + refFour+ " " +  fournisseur  + " " + refClient + " " + client +" " + useValue +" " +tube + " " + temperatureClass + " " + diameter +" " + length );
		    ...
		    void saveData(ActionEvent event) {
		        ...
		        databaseController.saveDataToDatabaseTube( refInterne,singlePart, useValue, refFour, fournisseur, refClient, client , tube , diameter , length , temperatureClass );
		    }
