	...
	public void initialize(URL arg0, ResourceBundle arg1) {
	 ...
	 @FXML
	    ...
	    void recupererInfoWire() {
	        ...
	        System.out.println(singlePart + " " + refInterne + " " + refFour+ " " +  fournisseur  + " " + refClient + " " + client +" " + useValue +" " + section + " " + type + " " + temperatureClass);
	    ...
	    void saveData(ActionEvent event) {
	        ...
	        databaseController.saveDataToDatabaseWire( refInterne, singlePart ,useValue, refFour, fournisseur, refClient, client , section , type , temperatureClass );
